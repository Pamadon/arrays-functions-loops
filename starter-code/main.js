...
*/
//For loop searching for numbers in the array that are less than 20
var younger = [];
...
while (tempNum < ages.length) {
    console.log(ages[tempNum]);
    tempNum += 1;
};

var tempNums = 0
while (tempNums < ages.length && ages[tempNums] <= 20) {
